...
def calcularSalario():
    try:
        horasTrabalhadas = float(input("Informe o seu número de horas trabalhadas essa semana: "))
        valorHora = float(input("Informe o valor que você recebe por hora: "))
        ...
        print(f"Salário total da semana: R$ {salario:.2f}")

    except ValueError:
        print("Erro: Por favor, digite apenas número válidos.")
